...
def start(update: Update, context: CallbackContext) -> None:
    ...
    update.effective_message.reply_markdown_v2(
        ...
        '\n Must Follow @DEVSERVEINFO To Continue Send tweet link here and I will download media in the best available quality for you'
    )
    ...
    for tweet_id in tweet_ids:
        ...
        try:
            ...
            if media:
                ...
                update.effective_message.reply_text('Follow The Developer @DEVSERVEINFO  and Support', quote=True)
